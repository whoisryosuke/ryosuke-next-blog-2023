...
Ultimately, I was able to create a complete React component system in _\*\*only_ 135 KB of code 😳🤯 _(not minified/gzipped, but also not including peer dependencies like React and styled-components)._
...
<iframe
  src="https://codesandbox.io/embed/5z90r1rkjx"
  style={{
    width: "100%",
    height: "500px",
    border: 0,
...
## Why make _yet another_ React UI kit?
...
```js
<Grid>
  <Grid.Unit width={[1 / 3, 1 / 2, 1 / 3, 1 / 4]} bg="red">
    Thirds
  </Grid.Unit>
  <Grid.Unit width={[1 / 3, 1 / 2, 1 / 3, 1 / 4]} bg="blue">
    Thirds
  </Grid.Unit>
  <Grid.Unit width={[1 / 3, 1 / 2, 1 / 3, 1 / 4]} bg="teal">
    Thirds
  </Grid.Unit>
</Grid>
```
