...
It's as easy as 4 steps (_minus the part where you code a reusable package in PHP_) -- I was surprised too. Make sure before starting you've created a git repository in your project and committed your code. It's also required to have an account on [Github](http://github.com) and [Packagist](http://packagist).
...
One of the biggest principles of programming I try to apply is **DRY**, _don't repeat yourself_. When your code is probably already hosted on Github, it's only a two step process to get your code in a place where it's version controlled.
