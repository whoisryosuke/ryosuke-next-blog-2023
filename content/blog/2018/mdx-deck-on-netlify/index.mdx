...
<img
  src="./mdx-deck boilerplate 3.gif"
  alt="Example of the slide deck in action"
/>
...
Hosting on Netlify allows me to utilize [Github](http://github.com) as an code editor/IDE, make changes to my deck's repo, and deploy those to Netlify immediately. It gives me the power of a development environment _(on a delay)_ in the cloud.
