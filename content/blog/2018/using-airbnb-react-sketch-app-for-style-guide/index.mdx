...
![Airbnb's react-sketchapp styleguide example](./airbnb-react-sketchapp-styleguide.jpg)
...
![Airbnb's react-sketchapp styleguide example with Kushy edits](./kushy-react-sketchapp-style-guide.jpg)
