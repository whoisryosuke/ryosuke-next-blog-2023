...
Here's how I spin up a new Laravel project and use Docker for local development -- _without pulling all my hair out_:
...
5. Change the Laravel root ENV to use Laradock as host (_Laravel uses localhost, but Laradock accesses each service inside the Docker container using the service name_):
...
You should have your Laravel project deployed locally on a Docker development server! _Pretty simple right? 😁_
