...
- Unit testing _(and ideally visual regression)_
...
I'll quickly cover how I chose the CSS in JS library in correlation to design systems. If you're not that interested in those, just skip past to _"Starting your project"_.
...
- The HOC compiles the CSS _object_ into _actual CSS_ and injects it into the app (as `<style></style>` elements in the `<head>`)
